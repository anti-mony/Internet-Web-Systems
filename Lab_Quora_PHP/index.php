...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" role="navigation">
        <a class="navbar-brand col-md-3 d-flex justify-content-center" href="#">
            <img src="img/logo.png" alt="Prashn-Uttar" width="240" height="36">
        </a>
    ...
    <section class="jumbotron row" style="padding-top: 80px" id="trendBanner">
        <section class="col-md-4">
            ...
            <hr class="my-4">
            <a class="btn btn-primary" href="#" role="button">Floods</a>
            <a class="btn btn-primary" href="#" role="button">Mumbai</a>
            <a class="btn btn-primary" href="#" role="button">Donald Trump</a>
            <p></p>
            <a class="btn btn-primary" href="#" role="button">GST</a>
            <a class="btn btn-primary" href="#" role="button">Dream Theatre</a>
            <a class="btn btn-primary" href="#" role="button">Ganpati</a>
            <a class="btn btn-primary" href="#" role="button">Modi</a>
        ...
        <section class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        <img class="d-flex mr-3" src="img/ic_person_48px.svg" alt="Generic placeholder image">
